...
//Programa principal
{
  ...
  BotonIrACaja.addEventListener("click", () => {
    ...
    //Uso de funciones de arrays-Inicio
    alert("Total de productos de la compra: " + ArrayCarrito.length);
    ArrayCarrito.reverse();
    //Uso de funciones de arrays-Fin
    ...
    /*Uso de fetch y  promesa con then*/
